...
- **Avoid implicit project reloads.** Autonomous OpenCode phases start from a sterile discovery directory. Project `AGENTS.md` remains useful for manual sessions but is not paid for again in every isolated phase.
