...
1. Review independently from a fresh session. Compare the task spec, `allowed_paths`, controller-derived Git diff, acceptance criteria, and controller-supplied deterministic gate evidence.
