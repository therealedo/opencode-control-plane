...
- **v1.6.14 says controller actions are unavailable/misrouted or a gate invoked OpenCode:** update to v1.6.15 or newer through **Update everything**, then Resume. Controller scripts now use the controller's fixed Node runtime, and the guarded recovery preserves M001 while restoring attempt 1.
