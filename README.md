...
- **A new project says its allowed directories are not writable:** update to v1.6.9 or newer, then choose **Resume after resolving blocker**. Literal task directories now authorize files beneath them without widening the approved paths.
