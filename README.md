...
- **v1.6.14 says controller actions are unavailable/misrouted or a gate invoked OpenCode:** return to the main global dashboard and choose **Update everything**; do not use option 5 in the old project dashboard. Update to v1.6.17 or newer, reopen the project, then Resume. The guarded recovery preserves M001, its usage audit, and restores attempt 1.
